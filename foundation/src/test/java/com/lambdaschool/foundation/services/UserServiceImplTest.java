...
public class UserServiceImplTest
{
                        ...
                        Exception
    {
        ...
        User u2 = new User("cinnamon",
            "1234567",
            "cinnamon@lambdaschool.local","0", "0");
        u1.getRoles()
