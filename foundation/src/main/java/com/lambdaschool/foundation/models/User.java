    ...
    extends Auditable
{
    ...
    // This field is not boilerplate might need to be removed 1/1/2021
     ...
     */
    // One to Many relationship w/ userRoles
    @OneToMany(mappedBy = "user",
        cascade = CascadeType.ALL,
        orphanRemoval = true)
    @JsonIgnoreProperties(value = "user",
    ...
    // Below associations added 1/1/21 1:34pm
...
//    private List<MenuItemRating> menuitemratings = new ArrayList<>();
    ...
    // One to Many relationship w/ dinnerFavoriteTrucks
    @OneToMany(mappedBy = "user",
        cascade = CascadeType.ALL,
        orphanRemoval = true)
    @JsonIgnoreProperties(value = "user",
    ...
    // One to Many relationship w/ truckRatings
    @OneToMany(mappedBy = "user",
        cascade = CascadeType.ALL,
        orphanRemoval = true)
    @JsonIgnoreProperties(value = "user",
    ...
    // One to Many relationship w/ truck
//    @OneToMany(mappedBy = "user",
//        cascade = CascadeType.ALL,
//        orphanRemoval = true)
//    @JsonIgnoreProperties(value = "user",
...
//    private List<Truck> trucks = new ArrayList<>();
    ...
    // This might need to be removed 1/1/21 2:42pm
    ...
    // This might need to be removed 1/1/21 2:42pm
    public void setUserLongitude(String userLocation)
    {
        this.userLongitude = userLocation;
    }
